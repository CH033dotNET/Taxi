			...
			success: function (data) {
				switch (Status) {
					...
					case "4": {
						...
						$.ajax({
							...
							success: function (dataOrder) {
								...
								dataOrder.userId = data.Person.userId;
								//!!!!ConfirmClientOrder on clientSite

								//Confirm client order on the ClientSite
								$.ajax({
									url: "./Order/WaitYourCar/",
									data: dataOrder,
									dataType: 'json',
									success: function ()
									{ console.log('yyyeah'); },
								...
								operatorHub.server.confirmClientOrder(dataOrder);
								$('.deny' + OrderId).click();
							}
						});
					...
					case "5": {
						...
						//No free car message to ClientSite
						$.ajax({
							url: "./Order/NoFreeCar/",
							data: { userId: data.Person.UserId },
							dataType: 'json',
							success: function ()
							{ console.log('yyyeah'); },
							error: function () { console.log('nooo'); }
